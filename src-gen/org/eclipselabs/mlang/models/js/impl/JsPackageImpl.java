...
public class JsPackageImpl extends EPackageImpl implements JsPackage {
	 ...
	 * @see org.eclipselabs.mlang.models.js.JsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getFunction_Location() {
	 ...
	 * @generated
	 */
	public EReference getArgument_Location() {
	 ...
	 * @generated
	 */
	public EReference getArgument_Function() {
	...
	public void createPackageContents() {
		...
		createEReference(functionEClass, FUNCTION__LOCATION);
		...
		createEReference(argumentEClass, ARGUMENT__LOCATION);
		createEReference(argumentEClass, ARGUMENT__FUNCTION);
	}
	...
	public void initializePackageContents() {
		...
		functionEClass.getESuperTypes().add(theCommonPackage.getScope());

		// Initialize classes and features; add operations and parameters
		initEClass(functionEClass, Function.class, "Function", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFunction_Arguments(), this.getArgument(), this.getArgument_Function(), "arguments", null, 0, -1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFunction_Name(), ecorePackage.getEString(), "name", null, 0, 1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFunction_Location(), theCommonPackage.getLocation(), null, "location", null, 0, 1, Function.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getArgument_Location(), theCommonPackage.getLocation(), null, "location", null, 0, 1, Argument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getArgument_Function(), this.getFunction(), this.getFunction_Arguments(), "function", null, 0, 1, Argument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
