...
public class JsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JsPackage.FUNCTION: {
				Function function = (Function)theEObject;
				T result = caseFunction(function);
				if (result == null) result = caseScope(function);
				if (result == null) result = caseLocated(function);
				if (result == null) result = caseLocation(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsPackage.JOBJECT: {
				JObject jObject = (JObject)theEObject;
				T result = caseJObject(jObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JsPackage.ARGUMENT: {
